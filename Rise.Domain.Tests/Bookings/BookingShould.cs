...
{
    private readonly Boat _testBoat = new Boat("testBoat", Boat.BoatStatus.Available);
    private readonly DateTime _testBookingDate = DateTime.Now.AddDays(10);
    private readonly Booking.BookingStatus _testBookingStatus = Booking.BookingStatus.Active;
    ...
    public void NotBeCreatedWithNullUser()
    {
        ...
        exception.Message.ShouldBe("Value cannot be null. (Parameter 'User')");
    }
