...
namespace Rise.Domain.Tests.Batteries
{
        ...
        private static readonly User _testUser =  new User("auth0|testUserId","test@gmail.com")
    {
        ...
        private readonly Battery.BatteryStatus _testBatteryStatus = Battery.BatteryStatus.Available;
        ...
        public void AllowStatusChange()
        {
            ...
            testBattery.Status = Battery.BatteryStatus.Reserve;

            testBattery.Status.ShouldBe(Battery.BatteryStatus.Reserve);
        }
    }
}
