...
namespace Rise.Domain.Tests.Boats
{
    public class BoatShould
    {
        ...
        private readonly Boat.BoatStatus _testBoatStatus = Boat.BoatStatus.Available;
        ...
        public void AllowStatusChange()
        {
            ...
            testBoat.Status = Boat.BoatStatus.Booked;

            testBoat.Status.ShouldBe(Boat.BoatStatus.Booked);
        }
    }
}
