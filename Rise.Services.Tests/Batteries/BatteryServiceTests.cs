...
public class BatteryServiceTests
{
    ...
    public async Task CreateBattery_InValidBatteryDuplicateName_ThrowsException()
    {
        ...
        dbContext.Users.Add(user);
        await dbContext.SaveChangesAsync();
        Battery battery = new("Battery 99", Battery.BatteryStatus.Available, user);
        BatteryDto.Create newBattery = new BatteryDto.Create
        {
            Name = "Battery 99",
            UserId = user.Id,
    ...
    public async Task GetAllBatteries_ReturnsAllBatteries()
    {
        ...
        dbContext.Users.Add(user);
        await dbContext.SaveChangesAsync();
        Battery battery1 = new("Battery 99", Battery.BatteryStatus.Available, user);
        Battery battery2 = new("Battery 100", Battery.BatteryStatus.Reserve, user);
    ...
    public async Task GetBatteriesByStatusAsync_ReturnCorrectBatteries()
    {
        ...
        Battery battery1 = new("Battery 99", Battery.BatteryStatus.Available, user);
        Battery battery2 = new("Battery 100", Battery.BatteryStatus.Reserve, user);
        Battery battery3 = new("Battery 101", Battery.BatteryStatus.Available, user);
        Battery battery4 = new("Battery 102", Battery.BatteryStatus.OutOfService, user);
        Battery battery5 = new("Battery 103", Battery.BatteryStatus.InRepair, user);
        Battery battery6 = new("Battery 104", Battery.BatteryStatus.InRepair, user);
    ...
    public async Task GetBatteriesByStatusAsync_EmptyDatabase_ReturnsEmptyList()
    {
        ...
        //Act
        var batteries = await batteryService.GetBatteriesByStatusAsync(
            BatteryDto.BatteryStatus.Available
        );
    ...
    public async Task GetBatteryById_ValidId_ReturnBattery()
    {
        ...
        dbContext.Users.Add(user);
        await dbContext.SaveChangesAsync();
        var battery1 = new Battery("Battery 99", Battery.BatteryStatus.Available, user);
        var battery2 = new Battery("Battery 100", Battery.BatteryStatus.Reserve, user);
        var battery3 = new Battery("Battery 101", Battery.BatteryStatus.Available, user);
    ...
    public async Task UpdateBattery_ValidModel_ReturnsTrue()
    {
        ...
        {
            Name = "Battery 100",
            Status = BatteryDto.BatteryStatus.Reserve.ToString(),
            UserId = user.Id,
        };
        ...
        updatedBattery.Status.ShouldBe(Battery.BatteryStatus.Reserve);
    }
